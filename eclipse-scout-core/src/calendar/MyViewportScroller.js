...
export default class MyViewportScroller {
  ...
  update(mouse) {
    ...
    const SLOW = MyViewportScroller.SPEED_FACTOR_SLOW;
    const MEDIUM = MyViewportScroller.SPEED_FACTOR_MEDIUM;
    const FAST = MyViewportScroller.SPEED_FACTOR_FAST;
    let speedFactorX = 0;
    let speedFactorY = 0;
